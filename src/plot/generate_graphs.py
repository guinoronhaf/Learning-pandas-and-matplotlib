...
# from aux.auxiliar_functions import map_times_by_rate, get_data_frame_app_rate, group_percentage_years_specialist, group_speciality_quantity
from ..aux.auxiliar_functions import map_times_by_rate
